...
def test_quickly_mined_block():
        last_block = Block.mine_block(Block.genesis(), 'pk')
        mined_block = Block.mine_block(last_block, 'nathan')
...
def test_mined_blocked_difficulty_limits_at_1():
        last_block = Block(
                time.time_ns(),
                'test_last_hash',
                'test_hash',
...
def test_is_valid_block_bad_block_hash(last_block, block):
        block.hash = '00000000000000000accef'
